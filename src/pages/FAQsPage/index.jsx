  ...
  <div id="accordion">
    ...
    <div className="card" >
      ...
      <div id="collapseOne" className="collapse show" data-bs-parent="#accordion">
        ...
        <p>The earliest and most reliable sign of pregnancy is a missed period. If you have a regular monthly cycle, normally you get your period about 4 weeks from the start of your last period.<br/>

<strong>Take a home pregnancy test</strong><br/>
To find out if you're pregnant, you can do a pregnancy test from the first day you miss your period. Home pregnancy tests are very reliable, but see your GP to be sure and also to start your antenatal care.<br/>

<strong>Early signs and symptoms</strong><br/>
...
Every woman is different and not all women will notice all these symptoms. If you're eagerly looking out for any hints that you might be pregnant, other early signs of pregnancy include:</p>


  <li>needing to pee more often – you may find you have to get up in the night</li>
  <li>being constipated</li>
  <li>increased vaginal discharge without any soreness or irritation</li>
  <li>feeling tired</li>
  <li>having a strange taste in your mouth – many women describe it as metallic</li>
  <li>"going off" some things, such as tea, coffee, tobacco smoke or fatty food</li>
    ...
    <div className="card">
      ...
      <div id="collapseTwo" className="collapse" data-bs-parent="#accordion">
        <div className="card-body">
          <p>There isn't a specific time when pregnancy food cravings start. It's different for every woman – and you may not necessarily have any cravings.
...
If you find yourself craving things that aren't food, like toothpaste, coal or even soil, speak to your midwife or doctor, as this may be a sign of a vitamin deficiency.</p>
        </div>
      </div>
    </div>
    <div className="card">
      ...
      <div id="collapseThree" className="collapse" data-bs-parent="#accordion">
        <div className="card-body">
          <p>Weight gain in pregnancy varies from person to person. It also depends on your weight before you become pregnant.
...
Putting on too much or too little weight while you're pregnant can lead to health problems for you or your unborn baby. But don't worry, it's easy to make healthy food choices. Find out what to eat when pregnant and what foods to avoid.</p>
        </div>
      </div>
    ...
    <div className="card">
      ...
      <div id="collapseFour" className="collapse" data-bs-parent="#accordion">
        <div className="card-body">
          <p>You'll get most of the vitamins and minerals you need by eating a healthy, varied diet. But when you're pregnant (and while you are trying to get pregnant) you also need to take a folic acid supplement.
...
Find out more about vitamins and supplements in pregnancy.</p>
        </div>
      </div>
    ...
    <div className="card">
      ...
      <div id="collapseFive" className="collapse" data-bs-parent="#accordion">
        <div className="card-body">
          <p>Keeping active and doing exercise while you're pregnant is great for you and your baby. You can keep up your normal level of daily activity and exercise regime, as long as it still feels comfortable.
...
Contact sports are not a good idea either – things like squash, tennis, martial arts, football and rugby. where there's a risk of your bump being hit.</p>
        </div>
      </div>
    </div>
    ...
    <div className="card">
      ...
      <div id="collapseSix" className="collapse" data-bs-parent="#accordion">
        <div className="card-body">
          <p>Depending on how you normally like to snooze, you might have to rethink your favourite position while you're pregnant.
...
daytime naps</p>
    ...
    <div className="card">
      ...
      <div id="collapseSeven" className="collapse" data-bs-parent="#accordion">
        <div className="card-body">
          <p>Antenatal classNamees are available to give you and your partner lots of helpful information on labour, birth and early parenthood.

They're usually informal, fun and sociable, which makes them a great place to meet other parents-to-be. The friends you make at antenatal classNamees can become a great support network. You can now find many antenatal courses and workshops online.

Antenatal classNamees usually start 8 to 10 weeks before your baby is born, and happen once a week for about 2 hours.

You can choose classNamees that are just for pregnant women, or classNamees that welcome a partner or a friend. There are sometimes classNamees especially designed for single mothers or teenagers.

Antenatal classNamees may include info on:
...
Find an antenatal className near you through the NCT or Our Place online courses.</p>
        </div>
      </div>
    </div>
    ...
    <div className="card">
      ...
      <div id="collapseEight" className="collapse" data-bs-parent="#accordion">
        <div className="card-body">
          <p>There are 2 different types of breast pump: electric and manual. They're both designed to mimic the sucking action your baby makes when they're breastfeeding.
...
Mums often say that a manual breast pump is better if you're only expressing occasionally, while an electric pump is more efficient if you need to express milk quickly and often, for example if you've gone back to work.</p>
        </div>
      </div>
    </div>
    ...
    <div className="card">
      ...
      <div id="collapseNine" className="collapse" data-bs-parent="#accordion">
        <div className="card-body">
          <p>It's a good idea to read as much as you can about breastfeeding before the birth. This will help you feel more confident and prepared. There is lots of useful information and practical tips in our feeding your baby section. Read about breastfeeding positions, how to express your breast milk, and practical tips on dealing with common breastfeeding issues. If you have any breastfeeding questions, you can always ask the Breastfeeding Friend voice assistant from Start for Life, available on Amazon Alexa, Facebook Messenger and Google Home, 24/7.</p>
        </div>
      </div>
    </div>
    ...
    <div className="card">
      ...
      <div id="collapseTen" className="collapse" data-bs-parent="#accordion">
        <div className="card-body">
          <p>If you're giving your baby expressed or formula milk, you'll need to buy some bottles. The choice of baby bottles can be overwhelming as there are quite a few options. When you start bottle feeding, don't buy loads as your baby may not necessarily like the ones you've chosen. Better to start off with a few and, if your baby approves, you can always buy more.
...
You can also get variflow teats – some of these can be manually adjusted, while others automatically increase in flow as your baby's sucking gets stronger.</p>
        </div>
      </div>
    </div>
    ...
    <div className="card">
      ...
      <div id="collapseEleven" className="collapse" data-bs-parent="#accordion">
        <div className="card-body">
          <p>A birth plan is a way of letting your midwife, nurses and doctors know what you want to happen during your labour. It's a chance to plan things like where you want to give birth, who's going to be with you during the birth, and what facilities you'd like to use.
...
You can download an NHS birth plan template. While you're writing your birth plan, talk to your midwife about your choices so they understand and can advise you.</p>
        </div>
      </div>
    </div>
    ...
    <div className="card">
      ...
      <div id="collapseTwelve" className="collapse" data-bs-parent="#accordion">
        <div className="card-body">
          <p>The flu jab is the safest way to help protect pregnant women and their babies against flu, regardless of their stage in pregnancy, or how fit and healthy they feel.
...
One of the most common flu complications is bronchitis - a chest infection that can become serious and develop into pneumonia. Read more about the flu jab in pregnancy on the NHS website.</p>
        </div>
      </div>
    </div>
